<div class="grid gap-4 sm:grid-cols-2">
    <div>
        ...
        <select id="{{ $prefix }}-type" wire:model="{{ $model }}.type" required class="input-premium mt-2 w-full">
    ...
    <div>
        ...
        <input id="{{ $prefix }}-label" wire:model="{{ $model }}.label" class="input-premium mt-2 w-full">
    </div>
</div>
...
<div>
    ...
    <input id="{{ $prefix }}-recipient-name" wire:model="{{ $model }}.recipient_name" required autocomplete="name" class="input-premium mt-2 w-full">
</div>

<div>
    <label for="{{ $prefix }}-company" class="text-sm font-bold text-cocoa dark:text-cream">{{ __('home.account.addresses.company') }}</label>
    <input id="{{ $prefix }}-company" wire:model="{{ $model }}.company" autocomplete="organization" class="input-premium mt-2 w-full">
</div>
...
<div>
    ...
    <input id="{{ $prefix }}-street-line-1" wire:model="{{ $model }}.street_line_1" required autocomplete="address-line1" class="input-premium mt-2 w-full">
</div>
...
<div>
    ...
    <input id="{{ $prefix }}-street-line-2" wire:model="{{ $model }}.street_line_2" autocomplete="address-line2" class="input-premium mt-2 w-full">
</div>
...
<div class="grid gap-4 sm:grid-cols-3">
    <div>
        ...
        <input id="{{ $prefix }}-postal-code" wire:model="{{ $model }}.postal_code" required autocomplete="postal-code" class="input-premium mt-2 w-full">
    </div>
    <div>
        <label for="{{ $prefix }}-city" class="text-sm font-bold text-cocoa dark:text-cream">{{ __('home.account.addresses.city') }}</label>
        <input id="{{ $prefix }}-city" wire:model="{{ $model }}.city" required autocomplete="address-level2" class="input-premium mt-2 w-full">
    </div>
    <div>
        <label for="{{ $prefix }}-region" class="text-sm font-bold text-cocoa dark:text-cream">{{ __('home.account.addresses.region') }}</label>
        <input id="{{ $prefix }}-region" wire:model="{{ $model }}.region" autocomplete="address-level1" class="input-premium mt-2 w-full">
    </div>
</div>
...
<div class="grid gap-4 sm:grid-cols-2">
    <div>
        ...
        <select id="{{ $prefix }}-country-code" wire:model="{{ $model }}.country_code" required autocomplete="country" class="input-premium mt-2 w-full">
    ...
    <div>
        ...
        <input id="{{ $prefix }}-phone" wire:model="{{ $model }}.phone" autocomplete="tel" class="input-premium mt-2 w-full">
    </div>
</div>
